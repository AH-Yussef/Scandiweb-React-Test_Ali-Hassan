    ...
    return (
        ...
        >
          <Link to={`/products/${id}`} className='text-link product-card-body'>
            {!inStock && (
              <div className='out-of-stock fs-24 fw-regular upper-case vh-center text-dark-gray'>out of stock</div>
            )}
          ...
          {isAddToCartShown && inStock && attributes.length === 0 && (
            <button className={this.setAddToCartBtnClasses()} onClick={this.addToCart} disabled={inCart}>
